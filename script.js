...
async function loadPage(page) {
  ...
  document.body.classList.toggle('page-publications', page === 'publications');
  document.body.classList.toggle('page-misc', page === 'misc');
  try {
    ...
    // Update page title
    const pageTitles = { about: 'About', publications: 'Publications', misc: 'Miscellaneous'};
...
// More About Me gallery auto slider
function initMoreAboutGallery() {
  const galleries = document.querySelectorAll('.more-about-gallery .gallery-stack');
